...
return [
    ...
    'account_reauthenticate' => 'Impossible de mettre à jour le compte. Veuillez ré-authentifier votre compte.',
    ...
    'confirm_delete_account' => 'Êtes-vous sûr(e) de vouloir supprimer ce compte ?',
    'account_not_updated' => 'Le compte ne peut pas être mis à jour.',
    'account_no_entities' => 'Le compte ne comporte aucune entité.
...
',
    'choose_entity' => 'Sélectionnez une entité',
    'account_entities' => 'Entités de compte',
    ...
    'backend' => [
        'notification' => [
            'unauthorized' => [
                'subject' => 'Nous avons perdu la connexion - Action requise',
                'line1' => 'Il semble que nous ayons perdu la connexion avec votre compte :name (:provider).',
                'line2' => 'Tant que la connexion est perdue, nous ne pouvons pas publier d\'articles ni fournir d\'analyses pour ce compte. Veuillez reconnecter votre compte dès que possible !',
                'line3' => 'Pour reconnecter votre compte, cliquez sur le bouton ci-dessous puis sur le bouton "Ajouter un compte".',
            ],
        ],
    ],
