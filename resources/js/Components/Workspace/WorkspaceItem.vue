...
<template>
  <TableRow :hoverable="true">
    ...
    <TableCell>
      <Avatar :background-color="item.hex_color" :name="item.name" rounded-class="rounded-lg" />
    </TableCell>
    ...
    <TableCell>
      <div v-if="item.users.length" class="flex justify-start">
        ...
        <div v-if="remainingUserCount" class="mt-xs">+{{ remainingUserCount }}</div>
      </div>
    </TableCell>

    <TableCell>
      <WorkspaceItemAction :item-id="item.uuid" />
    </TableCell>
  </TableRow>
</template>
