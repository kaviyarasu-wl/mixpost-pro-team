...
const deleteWorkspace = () => {
  confirmation()
    ...
    .onConfirm(dialog => {
      ...
      router.delete(
        route(`${routePrefix}.workspaces.delete`, {
  ...
  <div>
    <div class="flex flex-row items-center justify-end gap-xs">
      <PureButtonLink
        ...
        :href="route('mixpost.switchWorkspace', { workspace: itemId, redirect: true })"
        method="post"
        as="button"
        type="button"
      >
      ...
      <PureButtonLink
        ...
        :href="route(`${routePrefix}.workspaces.view`, { workspace: itemId })"
      >
        <Eye />
      </PureButtonLink>
      ...
      <Dropdown placement="bottom-end">
        ...
        <template #content>
          ...
          <DropdownItem as="button" @click="deleteWorkspace">
            <template #icon>
