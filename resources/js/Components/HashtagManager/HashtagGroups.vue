...
const fetch = () => {
  ...
  axios
    .get(route('mixpost.hashtaggroups.index', { workspace: workspaceCtx.id }))
    .then(response => {
...
const deleteHashtag = group => {
  axios.delete(
    route('mixpost.hashtaggroups.delete', {
  ...
  emit(
    'update',
    props.groups.filter(item => item.id !== group.id)
  )
}
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex justify-end">
                ...
                <Dropdown placement="bottom-end">
                  ...
                  <template #content>
                    <DropdownItem as="button" @click="$emit('edit', group)">
                      <PencilSquare class="w-5! h-5! mr-1" />
                      {{ $t('general.edit') }}
                    </DropdownItem>

                    <DropdownItem as="button" @click="deleteHashtag(group)">
