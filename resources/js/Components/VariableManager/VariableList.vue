...
const fetch = () => {
  ...
  axios
    .get(route('mixpost.variables.index', { workspace: workspaceCtx.id }))
    .then(response => {
      emit('update', [
        ...[
          {
...
const deleteVariable = variable => {
  axios.delete(
    route('mixpost.variables.delete', {
              ...
              <div class="flex justify-end">
                ...
                <template v-if="!variable.default">
                  <Dropdown placement="bottom-end">
                    ...
                    <template #content>
                      <DropdownItem as="button" @click="$emit('edit', variable)">
                        <PencilSquare class="w-5! h-5! mr-1" />
                        {{ $t('general.edit') }}
                      </DropdownItem>

                      <DropdownItem as="button" @click="deleteVariable(variable)">
