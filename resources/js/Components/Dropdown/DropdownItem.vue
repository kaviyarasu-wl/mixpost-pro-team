...
const classes = computed(() => {
    return `flex items-center text-left w-full first:rounded-t-md last:rounded-b-md text-gray-800 transition ease-in-out duration-200 ${props.isActive ? 'bg-primary-50' : 'hover:bg-primary-50'}`;
});
