...
const fontStyleClass = props.isUppercase ? 'uppercase tracking-widest rtl:tracking-normal text-xs' : 'normal-case text-base';
</script>

<template>
    <button :type="type" :class="sizeClass, fontStyleClass"
