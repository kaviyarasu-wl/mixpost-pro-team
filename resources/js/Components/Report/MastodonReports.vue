...
<template>
  <div class="row-px mt-2xl">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-sm">
      <Panel>
        <template #title
          ><span v-tooltip="$t('service.mastodon.report.number_replies')">
      ...
      <Panel>
        <template #title
          ><span v-tooltip="$t('service.mastodon.report.number_reblogs')">{{
            $t('service.mastodon.report.reblogs')
          }}</span>
        </template>
      ...
      <Panel>
        <template #title
          ><span v-tooltip="$t('service.mastodon.report.favourites_number')">{{
            $t('service.mastodon.report.favourites')
          }}</span>
        </template>
