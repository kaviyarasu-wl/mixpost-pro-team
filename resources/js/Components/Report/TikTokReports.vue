...
<template>
  <div class="row-px mt-2xl">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-sm">
      ...
      <Panel>
        <template #title
          ><span v-tooltip="$t('service.tiktok.report.views_video')">{{
            $t('service.tiktok.report.views')
          }}</span>
        </template>
      ...
      <Panel>
        <template #title
          ><span v-tooltip="$t('service.tiktok.report.number_shares')">{{
      ...
      <Panel>
        <template #title
          ><span v-tooltip="$t('service.tiktok.report.number_comments')">{{
            $t('report.comments')
          }}</span>
        </template>
