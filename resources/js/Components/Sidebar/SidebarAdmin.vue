...
<template>
    <div class="w-full h-full flex flex-col pb-2xl pt-4rem bg-white border-r border-gray-200">
        ...
        <div class="relative mb-lg px-sm flex items-center flex-row">
        ...
        <div class="flex flex-col space-y-lg overflow-y-auto px-xl h-full">
            ...
            <MenuGroupBody>
                ...
                <MenuItem :url="route('mixpost.configs.theme.form')"
                          :active="$page.component === 'Admin/Configs/ThemeConfig' || $page.component === 'Admin/Configs/AIConfig'">
                    <template #icon>
                        <Cog/>
                    </template>
                    {{ $t('general.settings') }}
