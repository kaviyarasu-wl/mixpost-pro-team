...
<template>
  <Panel class="relative">
    <template v-if="content[0].media.length">
      <Alert v-if="!isDirectShareType" class="mb-sm" :closeable="false">
        {{ $t('service.tiktok.direct_share_type') }}
      </Alert>

      <div
        v-if="content[0].media[0].is_video"
        class="relative overflow-hidden rounded-xl mx-auto max-w-(--container-md)"
      >
                  ...
                  <div class="flex flex-col space-y-lg">
                    ...
                    >
                      ...
                      <span class="absolute -bottom-xs flex justify-center">
                        <span
                          class="w-4 h-4 bg-red-600 text-white flex items-center justify-center rounded-full font-medium"
                          >+</span
                        >
                      </span>
                    </div>
                ...
                <div class="absolute bottom-md px-md pr-2xl w-full">
                  ...
                  <template v-if="isDirectShareType">
                    <EditorReadOnly
                      ...
                      :class="{
                        'mt-xs': !isDocEmpty(content[0].body),
                        hidden: isDocEmpty(content[0].body)
                      }"
