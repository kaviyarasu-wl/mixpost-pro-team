...
<template>
  ...
  <div
    class="mt-5 flex items-center justify-around border-t border-b border-gray-200 text-gray-500 py-2"
  >
    <div class="flex items-center">
      <i
        :style="{
          backgroundImage: `url(${fbIconsImgUrl})`,
          backgroundPosition: '0px -342px',
          backgroundSize: '25px 867px'
        }"
        class="facebook-toolbar-icon"
      ></i>
