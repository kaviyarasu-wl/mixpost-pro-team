...
<template>
  <Panel class="relative">
      ...
      <div class="flex items-center">
        <div class="mr-sm">
          <span class="inline-flex justify-center items-center shrink-0 w-10 h-10 rounded-full">
            <img v-if="image" :src="image" class="object-cover w-full h-full rounded-full" alt="" />
            <template v-else>
              <Avatar :name="name" />
            </template>
          </span>
    ...
    <div class="w-full">
      ...
      <div
        class="mt-md pt-md flex items-center justify-around border-t border-gray-200 text-gray-700"
      >
        <div class="flex items-center">
          <svg
            class="w-6 h-6 mr-1"
