...
<template>
  <Link
    :href="route('mixpost.accounts.add', { workspace: workspaceCtx.id, provider: 'twitter' })"
    method="post"
    as="button"
    type="button"
    class="w-full flex items-center px-lg py-4 hover:bg-twitter/20 ease-in-out duration-200"
  >
