...
<template>
  ...
  <div class="w-full mx-auto row-py">
    ...
    <div class="w-full row-px">
      ...
      <Panel class="mt-lg">
        ...
        <template #description>{{ $t('posting_schedule.send_posting_schedule') }} </template>
      ...
      <PrimaryButton :disabled="form.processing" class="mt-md" @click="update">
  ...
  <ConfirmationModal :show="confirmationClear" variant="danger" @close="confirmationClear = false">
    ...
    <template #footer>
      <SecondaryButton class="mr-xs" @click="confirmationClear = false">
        {{ $t('general.cancel') }}
      </SecondaryButton>
