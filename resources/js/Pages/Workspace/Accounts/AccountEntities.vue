...
<template>
  ...
  <div class="w-full mx-auto row-py">
    ...
    <div class="mt-lg row-px">
      <Panel>
        <div v-for="entity in entities" :key="entity.id" class="mb-sm last:mb-0">
          <label class="flex items-center cursor-pointer">
            ...
            <span class="flex items-center">
              ...
              <template v-else>
                <div class="rounded-full w-8 h-8 object-cover mr-xs border border-gray-200" />
              </template>
              <span>
                <span class="font-semibold">
                  ...
                  <span
                    v-if="
                      entity.data &&
                      Object.prototype.hasOwnProperty.call(entity.data, 'suffix') &&
                ...
                <span v-if="entity.connected" class="block text-green-500 text-sm font-medium">
      ...
      <div v-if="entities.length">
        <PrimaryButton class="mt-lg" :disabled="!form.selected.length" @click="save">
