  ...
  <div class="w-full mx-auto row-py">
    ...
    <div class="mt-lg row-px w-full">
      <SelectableBar :count="selectedRecords.length" @close="deselectAllRecords">
        <PureDangerButton v-tooltip="$t('general.delete')" @click="deleteWorkspaces">
          <TrashIcon />
        </PureDangerButton>
      </SelectableBar>
      ...
      <template v-if="enterpriseConsole.url">
        <Alert variant="warning" :closeable="false" class="mb-lg">
          Manage Workspaces from the
          <a :href="`${enterpriseConsole.url}/workspaces`" class="link">Enterprise Console</a> for
