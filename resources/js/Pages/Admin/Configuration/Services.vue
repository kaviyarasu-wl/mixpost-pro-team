...
const ClaudeServiceForm = defineAsyncComponent(() => import("@/Components/ServiceForm/ClaudeServiceForm.vue"));
...
<template>
    <Head :title="$t('service.third_party_services')"/>

    <div class="row-py w-full mx-auto">
        <PageHeader :title="$t('service.third_party_services')">
        ...
        <div class="w-full row-px mb-lg">
            <Tabs>
                ...
                <Tab @click="tab = 'claude'" :active="tab === 'claude'">
                    <template #icon>
                        <Claude class="text-claude"/>
                    </template>
                    Claude
                </Tab>
            </Tabs>
        ...
        <div class="row-px">
            ...
            <template v-if="tab === 'claude'">
                <ClaudeServiceForm :form="form.claude"/>
            </template>
        </div>
    </div>
</template>
