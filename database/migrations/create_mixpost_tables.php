...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('mixpost_posts', function (Blueprint $table) {
            ...
            $table->bigInteger('workspace_id')->unsigned()->index();
            $table->bigInteger('user_id')->unsigned()->index();
            $table->bigInteger('updated_by')->nullable(); // user_id of the last user who updated the post
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('mixpost_user_tokens');
        ...
        Schema::dropIfExists('mixpost_post_activities_ns');
        Schema::dropIfExists('mixpost_post_activity_reactions');
